...
static const _RigidBody_type_support_symbol_names_t _RigidBody_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rigidbody_msgs, msg, RigidBody)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rigidbody_msgs, msg, RigidBody)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rigidbody_msgs, msg, RigidBody)() {
  return &::rigidbody_msgs::msg::rosidl_typesupport_c::RigidBody_message_type_support_handle;
}
