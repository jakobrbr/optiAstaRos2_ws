...
static const _RobotCmd_type_support_symbol_names_t _RobotCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rigidbody_msgs, msg, RobotCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rigidbody_msgs, msg, RobotCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rigidbody_msgs, msg, RobotCmd)() {
  return &::rigidbody_msgs::msg::rosidl_typesupport_c::RobotCmd_message_type_support_handle;
}
