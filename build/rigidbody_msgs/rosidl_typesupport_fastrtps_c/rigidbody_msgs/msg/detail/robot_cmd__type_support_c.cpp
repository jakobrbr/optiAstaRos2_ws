...
#include "rigidbody_msgs/msg/detail/robot_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _RobotCmd__ros_msg_type = rigidbody_msgs__msg__RobotCmd;
...
size_t get_serialized_size_rigidbody_msgs__msg__RobotCmd(
  const void * untyped_ros_message,
...
static uint32_t _RobotCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rigidbody_msgs__msg__RobotCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rigidbody_msgs
size_t max_serialized_size_rigidbody_msgs__msg__RobotCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _RobotCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rigidbody_msgs__msg__RobotCmd(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rigidbody_msgs, msg, RobotCmd)() {
