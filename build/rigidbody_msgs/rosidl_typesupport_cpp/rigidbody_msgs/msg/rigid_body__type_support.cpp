...
static const _RigidBody_type_support_symbol_names_t _RigidBody_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rigidbody_msgs, msg, RigidBody)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rigidbody_msgs, msg, RigidBody)),
  }
};
...
{
  return &::rigidbody_msgs::msg::rosidl_typesupport_cpp::RigidBody_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rigidbody_msgs, msg, RigidBody)() {
  return get_message_type_support_handle<rigidbody_msgs::msg::RigidBody>();
}
