...
class ControllerNode(Node):
    ...
    def __init__(self):
        ...
        self.targetPosArr, stop_pos, stop_orient = (generateRobotPath.pointsFromDoc(svg_str,density=0.3, scale=1)) # set density and scale of path
    ...
    def pose_callback(self, msg: RigidBody):
        ...
        for j in range(0,len(self.targetPosArr)):
            if self.targetPosArr[j]:
                ...
                self.velocity[j] = 0.75 # constant low linear velocity, maybe set to 1 again or 0.5
